 ...
 * <pre>基础CRUD 控制器</pre>
 *
 * @ClassName： BaseCRUDController.java
 * @Author： chenpan
 * @Date：2024/11/30 15:55
 * @Modify：
 */
public abstract class BaseCRUDController<E extends BaseEntity, V extends BaseEntity, Q extends AbstractEntity> extends BaseRestController<E, V>
