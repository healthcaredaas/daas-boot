package cn.healthcaredaas.data.cloud.core.jackson;
...
public class JacksonUtils {
    ...
    public static <T> String toJson(T domain) {
        try {
            ...
            logger.error("[DaaS] Jackson json processing error, when to json! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static <T> T toObject(String content, Class<T> valueType) {
        try {
            ...
            logger.error("[DaaS] Jackson json processing error, when to object with value type! {}", e.getMessage());
            return null;
        }
    }

    public static <T> T toObject(Map content, Class<T> valueType) {
        try {
    ...
    public static <T> T toObject(String content, TypeReference<T> typeReference) {
        try {
            ...
            logger.error("[DaaS] Jackson json processing error, when to object with type reference! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static <T> T toObject(String content, JavaType javaType) {
        try {
            ...
            logger.error("[DaaS] Jackson json processing error, when to object with java type! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static JsonNode toNode(String content) {
        try {
            ...
            logger.error("[DaaS] Jackson json processing error, when to node with string! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static JsonNode toNode(JsonParser jsonParser) {
        try {
            ...
            logger.error("[DaaS] Jackson io error, when to node with json parser! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static JsonParser createParser(String content) {
        try {
            ...
            logger.error("[DaaS] Jackson io error, when create parser! {}", e.getMessage());
            return null;
        }
    }
