...
/**
 * <pre>自定义Opaque Token</pre>
 *
 * @ClassName： OpaqueTokenCustomizer.java
 * @Author： chenpan
 * @Date：2024/12/1 17:14
 * @Modify：
 */
public class OpaqueTokenCustomizer extends AbstractTokenCustomizer implements OAuth2TokenCustomizer<OAuth2TokenClaimsContext> {
